...
export const UserModifier = (props: { user: User }) => {
  ...
  return (
    <div className="fixed bottom-4 right-20 p-4 z-10 bg-green-600 rounded-md shadow-md">
      {!open && (
        <FaUser role="button" className="text-white" onClick={handleClick} />
      )}
      {open && (
